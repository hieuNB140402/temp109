...
public class MuPDFCore {
	...
	private native void addInkAnnotationInternal(final PointF[][] p0, final float[] colors);
...
//        colors[3] = Color.alpha(color) / 255f;
	...
	public synchronized void addInkAnnotation(final int page, final PointF[][] arcs) {
		this.gotoPage(page);
...
//        colors[3] = Color.alpha(color) / 255f;
		...
		this.addInkAnnotationInternal(arcs, colors);
	}
