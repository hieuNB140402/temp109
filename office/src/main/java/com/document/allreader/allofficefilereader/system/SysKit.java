...
import com.document.allreader.allofficefilereader.common.bookmark.BookmarkManage;
import com.document.allreader.allofficefilereader.common.borders.BordersManage;
import com.document.allreader.allofficefilereader.common.bulletnumber.ListManage;
import com.document.allreader.allofficefilereader.common.hyperlink.HyperlinkManage;
import com.document.allreader.allofficefilereader.common.picture.PictureManage;
import com.document.allreader.allofficefilereader.pg.animate.AnimationManager;
import com.document.allreader.allofficefilereader.pg.model.PGBulletText;
import com.document.allreader.allofficefilereader.system.beans.CalloutView.CalloutManager;
import com.document.allreader.allofficefilereader.wp.control.WPShapeManage;
...
public class SysKit
{
    ...
    public void internetSearch(String str, AppCompatActivity activity)
    {    
    ...
    public static Drawable getPageNubmerDrawable()
    {
        ...
        {
            pageNumberDrawable = new ShapeDrawable(new RoundRectShape(new float[]{50, 50, 50, 50,
                    50, 50, 50, 50}, null, null));

            pageNumberDrawable.getPaint().setColor(Color.parseColor("#5D6063"));
