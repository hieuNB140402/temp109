...
import com.document.allreader.allofficefilereader.common.bookmark.Bookmark;
import com.document.allreader.allofficefilereader.common.borders.Border;
import com.document.allreader.allofficefilereader.common.borders.Borders;
...
import com.document.allreader.allofficefilereader.common.shape.WPAbstractShape;
import com.document.allreader.allofficefilereader.common.shape.WPAutoShape;
import com.document.allreader.allofficefilereader.common.shape.WPGroupShape;
...
import com.document.allreader.allofficefilereader.fc.hwpf.model.ListFormatOverride;
import com.document.allreader.allofficefilereader.fc.hwpf.model.ListTables;
import com.document.allreader.allofficefilereader.fc.hwpf.model.POIListData;
import com.document.allreader.allofficefilereader.fc.hwpf.model.POIListLevel;
import com.document.allreader.allofficefilereader.fc.hwpf.model.PicturesTable;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.Bookmarks;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.BorderCode;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.CharacterRun;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.Field;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.HWPFAutoShape;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.HWPFShape;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.HWPFShapeGroup;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.HeaderStories;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.InlineWordArt;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.OfficeDrawing;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.OfficeDrawings;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.POIBookmark;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.Paragraph;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.PictureType;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.Range;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.Section;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.Table;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.TableCell;
import com.document.allreader.allofficefilereader.fc.hwpf.usermodel.TableRow;
...
import com.document.allreader.allofficefilereader.java.util.Arrays;
...
import com.document.allreader.allofficefilereader.wp.model.CellElement;
import com.document.allreader.allofficefilereader.wp.model.HFElement;
import com.document.allreader.allofficefilereader.wp.model.RowElement;
import com.document.allreader.allofficefilereader.wp.model.TableElement;
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType)
    {
        ...
        if (shape != null)
        {
            		...
            		|| type == BackgroundAndFill.FILL_SHADE_RECT || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.document.allreader.allofficefilereader.java.awt.Color fillColor = shape.getForegroundColor();
            	com.document.allreader.allofficefilereader.java.awt.Color fillbackColor = shape.getFillbackColor();
   ...
   /*         	byte[] data = drawing.getBGPictureData(shape.getBackgroundPictureIdx());
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape)
    {
		...
		if(text != null && text.length() > 0)
		{
            ...
            com.document.allreader.allofficefilereader.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, MainConstant.APPLICATION_TYPE_PPT);
            if(color != null)
            {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex)
    {
        ...
        else
        {
            ...
            com.document.allreader.allofficefilereader.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                run, false);
