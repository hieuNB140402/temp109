...
import com.document.allreader.allofficefilereader.thirdpart.emf.data.BitmapInfoHeader;
import com.document.allreader.allofficefilereader.thirdpart.emf.data.BlendFunction;
...
public class EMFImageLoader {
    ...
    public static Bitmap readImage(
        ...
        if (bmi.getBitCount() == 1) {
            ...
            f.setSize(new com.allreader.office.allofficefilereader.java.awt.Dimension(width + 20, height + 20));
            f.setVisible(true);*/
