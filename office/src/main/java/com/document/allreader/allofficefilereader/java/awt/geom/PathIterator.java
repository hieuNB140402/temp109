...
package com.document.allreader.allofficefilereader.java.awt.geom;

/**
 * The <code>PathIterator</code> interface provides the mechanism 
 * for objects that implement the {@link com.document.allreader.allofficefilereader.fc.hwpf.usermodel.Shape Shape}
 ...
 * For example, the {@link com.document.allreader.allofficefilereader.thirdpart.achartengine.renderers.BasicStroke BasicStroke} object
 ...
 *
 * @see com.document.allreader.allofficefilereader.fc.hwpf.usermodel.Shape
 * @see com.document.allreader.allofficefilereader.thirdpart.achartengine.renderers.BasicStroke
 *
 * @version %I%, %G%
 * @author Jim Graham
 */
