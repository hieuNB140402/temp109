 ...
 * 时间:               下午4:23:51
 */
package com.document.allreader.allofficefilereader.fc.ppt;
...
import com.document.allreader.allofficefilereader.common.PaintKit;
...
import com.document.allreader.allofficefilereader.common.bg.Gradient;
import com.document.allreader.allofficefilereader.common.bg.LinearGradientShader;
import com.document.allreader.allofficefilereader.common.bg.RadialGradientShader;
import com.document.allreader.allofficefilereader.common.bg.TileShader;
...
import com.document.allreader.allofficefilereader.common.shape.Arrow;
...
import com.document.allreader.allofficefilereader.common.shape.TableCell;
import com.document.allreader.allofficefilereader.common.shape.TableShape;
...
import com.document.allreader.allofficefilereader.constant.wp.WPAttrConstant;
import com.document.allreader.allofficefilereader.constant.wp.WPModelConstant;
import com.document.allreader.allofficefilereader.fc.FCKit;
import com.document.allreader.allofficefilereader.fc.ShapeKit;
import com.document.allreader.allofficefilereader.fc.hslf.HSLFSlideShow;
import com.document.allreader.allofficefilereader.fc.hslf.model.Fill;
import com.document.allreader.allofficefilereader.fc.hslf.model.HeadersFooters;
import com.document.allreader.allofficefilereader.fc.hslf.model.Line;
import com.document.allreader.allofficefilereader.fc.hslf.model.MasterSheet;
import com.document.allreader.allofficefilereader.fc.hslf.model.Notes;
import com.document.allreader.allofficefilereader.fc.hslf.model.Shape;
import com.document.allreader.allofficefilereader.fc.hslf.model.ShapeGroup;
import com.document.allreader.allofficefilereader.fc.hslf.model.Sheet;
import com.document.allreader.allofficefilereader.fc.hslf.model.SimpleShape;
import com.document.allreader.allofficefilereader.fc.hslf.model.Slide;
import com.document.allreader.allofficefilereader.fc.hslf.model.SlideMaster;
import com.document.allreader.allofficefilereader.fc.hslf.model.TextShape;
import com.document.allreader.allofficefilereader.fc.hslf.model.TitleMaster;
import com.document.allreader.allofficefilereader.fc.hslf.record.BinaryTagDataBlob;
import com.document.allreader.allofficefilereader.fc.hslf.record.ClientVisualElementContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.DocumentAtom;
import com.document.allreader.allofficefilereader.fc.hslf.record.OEPlaceholderAtom;
import com.document.allreader.allofficefilereader.fc.hslf.record.PositionDependentRecordContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.Record;
import com.document.allreader.allofficefilereader.fc.hslf.record.SlideAtom;
import com.document.allreader.allofficefilereader.fc.hslf.record.SlideProgBinaryTagContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.SlideProgTagsContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.SlideShowSlideInfoAtom;
import com.document.allreader.allofficefilereader.fc.hslf.record.TimeAnimateBehaviorContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.TimeBehaviorContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.TimeColorBehaviorContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.TimeCommandBehaviorContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.TimeEffectBehaviorContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.TimeMotionBehaviorContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.TimeNodeAttributeContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.TimeNodeContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.TimeRotationBehaviorContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.TimeScaleBehaviorContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.TimeSetBehaviorContainer;
import com.document.allreader.allofficefilereader.fc.hslf.record.TimeVariant;
import com.document.allreader.allofficefilereader.fc.hslf.record.VisualShapeAtom;
import com.document.allreader.allofficefilereader.fc.hslf.record.SlideAtom.SSlideLayoutAtom;
import com.document.allreader.allofficefilereader.fc.hslf.usermodel.PictureData;
import com.document.allreader.allofficefilereader.fc.hslf.usermodel.RichTextRun;
import com.document.allreader.allofficefilereader.fc.hslf.usermodel.SlideShow;
import com.document.allreader.allofficefilereader.fc.ppt.bulletnumber.BulletNumberManage;
...
import com.document.allreader.allofficefilereader.java.awt.Rectanglef;
import com.document.allreader.allofficefilereader.java.awt.geom.Rectangle2D;
import com.document.allreader.allofficefilereader.pg.animate.ShapeAnimation;
import com.document.allreader.allofficefilereader.pg.model.PGModel;
import com.document.allreader.allofficefilereader.pg.model.PGNotes;
import com.document.allreader.allofficefilereader.pg.model.PGSlide;
import com.document.allreader.allofficefilereader.simpletext.font.FontTypefaceManage;
...
import com.document.allreader.allofficefilereader.ss.util.format.NumericFormatter;
import com.document.allreader.allofficefilereader.system.AbstractReader;
import com.document.allreader.allofficefilereader.system.BackReaderThread;
...
{   
    ...
    private com.document.allreader.allofficefilereader.common.borders.Line getShapeLine(SimpleShape shape)
    {
    	return getShapeLine(shape, false);
    }
    
    private com.document.allreader.allofficefilereader.common.borders.Line getShapeLine(SimpleShape shape, boolean isTableCellLine)
    {
        com.document.allreader.allofficefilereader.common.borders.Line line = null;
        if(shape != null && shape.hasLine())
        {
             ...
             com.document.allreader.allofficefilereader.java.awt.Color color = ((SimpleShape)shape).getLineColor();
             
             if(color != null)
             {
            	 line = new com.document.allreader.allofficefilereader.common.borders.Line();
    ...
    private BackgroundAndFill converFill(PGSlide pgSlide, Fill fill)
    {
        ...
        {        	
                    ...
                    || type == BackgroundAndFill.FILL_SHADE_SHAPE)
            {
            	...
            	com.document.allreader.allofficefilereader.java.awt.Color fillColor = fill.getForegroundColor();
            	com.document.allreader.allofficefilereader.java.awt.Color fillbackColor = fill.getFillbackColor();
    ...
    private void processNotes(PGSlide pgSlide, Notes notes)
    {
        if (notes != null)
        {
            ...
            for (Shape shape : notes.getShapes())
            {
                ...
                if(shape instanceof com.document.allreader.allofficefilereader.fc.hslf.model.AutoShape  // 文本框
                    || shape instanceof com.document.allreader.allofficefilereader.fc.hslf.model.TextBox)  // 占位符
                {
...
//        }
        ...
        if (shape instanceof Line
            || shape instanceof com.document.allreader.allofficefilereader.fc.hslf.model.Freeform
            || shape instanceof com.document.allreader.allofficefilereader.fc.hslf.model.AutoShape
            || shape instanceof com.document.allreader.allofficefilereader.fc.hslf.model.TextBox
            || shape instanceof com.document.allreader.allofficefilereader.fc.hslf.model.Picture)
        {  
            if (shape instanceof Line)
            {
                if (line != null)
            ...
            else if(shape instanceof com.document.allreader.allofficefilereader.fc.hslf.model.Freeform)
            {              
                if (fill != null || line != null)
                {
                    ...
                    if (startArrowType > 0)
                    {
                    	ArrowPathAndTail arrowPathAndTail = ((com.document.allreader.allofficefilereader.fc.hslf.model.Freeform)shape).getStartArrowPathAndTail(rect);
                    ...
                    if (endArrowType > 0)
                    {                        
                    	ArrowPathAndTail arrowPathAndTail = ((com.document.allreader.allofficefilereader.fc.hslf.model.Freeform)shape).getEndArrowPathAndTail(rect);
                    	if(arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null)
                        {
                    ...
                    Path[] paths = ((com.document.allreader.allofficefilereader.fc.hslf.model.Freeform)shape).getFreeformPath(rect,
            ...
            else if(shape instanceof com.document.allreader.allofficefilereader.fc.hslf.model.AutoShape
                    || shape instanceof com.document.allreader.allofficefilereader.fc.hslf.model.TextBox)
            {
                // autoShape
            ...
            // 图片
            else if(shape instanceof com.document.allreader.allofficefilereader.fc.hslf.model.Picture)
            {   
                com.document.allreader.allofficefilereader.fc.hslf.model.Picture poiPic = (com.document.allreader.allofficefilereader.fc.hslf.model.Picture)shape;
        ...
        else if(shape instanceof com.document.allreader.allofficefilereader.fc.hslf.model.Table)
        {
            com.document.allreader.allofficefilereader.fc.hslf.model.Table poiTable = (com.document.allreader.allofficefilereader.fc.hslf.model.Table)shape;
            if (poiTable != null)
            {
     ...
     * @param pgSlide
     */
    private void processTable(PGSlide pgSlide, com.document.allreader.allofficefilereader.fc.hslf.model.Table poiTable, GroupShape parent, int slideType)
    {
        ...
        for (int i = 0; i < rows; i++)
        {
            for (int j = 0; j < columns; j++)
            {
                ...
                com.document.allreader.allofficefilereader.fc.hslf.model.TableCell poiCell = poiTable.getCell(i, j);
                if (poiCell != null)
                {
        ...
        {
        	com.document.allreader.allofficefilereader.common.borders.Line aLine = getShapeLine(line, true);
            if (aLine != null)
            {
    ...
    private int getBorderColor(Line line)
    {
        if (line != null)
        {
            com.document.allreader.allofficefilereader.java.awt.Color color = line.getLineColor();
            if (color != null)
            {
    ...
    private void processNormalTextShape(TextBox tb, TextShape ts, Rectangle rect, int slideType, int placeHolderID)
    {
        ...
        if (text != null && text.trim().length() > 0)
        {
            ...
            int len = text.length();
            com.document.allreader.allofficefilereader.fc.hslf.model.Hyperlink[] links = ts.getTextRun().getHyperlinks();
            int start = 0;
            // title type just a paragraph needs be processed specially
            if (ts.getTextRun().getRunType() != com.document.allreader.allofficefilereader.fc.hslf.record.TextHeaderAtom.TITLE_TYPE)
            {
                for (int i = 0; i < len; i++)
                {
                    if (abortReader)
    ...
    private void processParagraph(SectionElement secElem, TextShape ts, String text,
                                  com.document.allreader.allofficefilereader.fc.hslf.model.Hyperlink[] links, int start, int end, int placeHolderID)
    {
        ...
        com.document.allreader.allofficefilereader.fc.hslf.record.TextRulerAtom ruler = ts.getTextRun().getTextRuler();
        if (ruler != null)
        {
...
//      }
    ...
    private int converterColor(com.document.allreader.allofficefilereader.java.awt.Color color)
    {
//        if(color.getAlpha() == 0)
//        {
