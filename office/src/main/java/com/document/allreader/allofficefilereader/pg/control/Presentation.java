...
import com.document.allreader.allofficefilereader.pg.view.SlideShowView;
...
public class Presentation extends FrameLayout implements IFind, IExportListener
{
    ...
    public Presentation(AppCompatActivity activity, PGModel pgModel, IControl control)
    {
        super(activity);
