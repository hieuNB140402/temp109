...
/* renamed from: com.allreader.office.allofficefilereader.fc.fs.filesystem.CFBConstants */
...
public interface CFBConstants {
    ...
    public static final BlockSize LARGER_BIG_BLOCK_SIZE_DETAILS = new BlockSize(4096, (short) 12);
    ...
    public static final BlockSize SMALLER_BIG_BLOCK_SIZE_DETAILS = new BlockSize(512, (short) 9);
