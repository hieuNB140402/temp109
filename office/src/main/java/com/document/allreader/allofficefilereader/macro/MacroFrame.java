...
class MacroFrame implements IMainFrame
{
     ...
     * 
     *(non-Javadoc)
     * @see com.document.allreader.allofficefilereader.system.IMainFrame#showProgressBar(boolean)
     *
     */
    ...
    /**
     * when need destroy allofficefilereader engine instance callback this method
     */
