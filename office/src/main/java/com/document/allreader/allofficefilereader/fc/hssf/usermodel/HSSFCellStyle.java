...
import com.document.allreader.allofficefilereader.fc.ss.usermodel.IFont;
 ...
 * @see com.document.allreader.allofficefilereader.fc.hssf.usermodel.HSSFWorkbook#createCellStyle()
 * @see com.document.allreader.allofficefilereader.fc.hssf.usermodel.HSSFWorkbook#getCellStyleAt(short)
 * @see com.document.allreader.allofficefilereader.fc.hssf.usermodel.HSSFCell#setCellStyle(HSSFCellStyle)
 */
public final class HSSFCellStyle implements ICellStyle {
     ...
     * @see com.document.allreader.allofficefilereader.fc.hssf.usermodel.HSSFDataFormat
     */
     ...
     * @return the format string or "General" if not found
     */
    public String getDataFormatString(com.document.allreader.allofficefilereader.fc.ss.usermodel.Workbook workbook) {
     ...
     * @see com.document.allreader.allofficefilereader.fc.hssf.usermodel.HSSFDataFormat
     */
    public String getDataFormatString(com.document.allreader.allofficefilereader.fc.hssf.model.InternalWorkbook workbook)
    {
...
//        return format.getFormat(getDataFormat());
     ...
     * @see com.document.allreader.allofficefilereader.fc.hssf.usermodel.HSSFWorkbook#createFont()
     * @see com.document.allreader.allofficefilereader.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
     ...
     * @see com.document.allreader.allofficefilereader.fc.hssf.usermodel.HSSFCellStyle#getFontIndex()
     * @see com.document.allreader.allofficefilereader.fc.hssf.usermodel.HSSFWorkbook#getFontAt(short)
     */
    public HSSFFont getFont(com.document.allreader.allofficefilereader.fc.ss.usermodel.Workbook parentWorkbook) {
     ...
     * @see com.document.allreader.allofficefilereader.fc.hssf.usermodel.HSSFPalette#getColor(short)
    ...
    private void checkDefaultBackgroundFills() {
      if (_format.getFillForeground() == com.document.allreader.allofficefilereader.fc.hssf.util.HSSFColor.AUTOMATIC.index) {
    	  ...
    	  if (_format.getFillBackground() != (com.document.allreader.allofficefilereader.fc.hssf.util.HSSFColor.AUTOMATIC.index+1))
    		  setFillBackgroundColor((short)(com.document.allreader.allofficefilereader.fc.hssf.util.HSSFColor.AUTOMATIC.index+1));
      } else if (_format.getFillBackground() == com.document.allreader.allofficefilereader.fc.hssf.util.HSSFColor.AUTOMATIC.index+1)
    	  //Now if the forground changes to a non-AUTOMATIC color the background resets itself!!!
    	  if (_format.getFillForeground() != com.document.allreader.allofficefilereader.fc.hssf.util.HSSFColor.AUTOMATIC.index)
    		  setFillBackgroundColor(com.document.allreader.allofficefilereader.fc.hssf.util.HSSFColor.AUTOMATIC.index);
    }
