...
public class ASheet extends Sheet implements com.document.allreader.allofficefilereader.fc.ss.usermodel.Sheet
{
    ...
    protected ASheet(AWorkbook workbook, InternalSheet sheet)
    {
        ...
        List<com.document.allreader.allofficefilereader.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if(hssfColumnInfoList != null)
        {
            Iterator<com.document.allreader.allofficefilereader.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while(iter.hasNext())
            {
                com.document.allreader.allofficefilereader.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.document.allreader.allofficefilereader.ss.model.sheetProperty.ColumnInfo columnInfo = new com.document.allreader.allofficefilereader.ss.model.sheetProperty.ColumnInfo(
