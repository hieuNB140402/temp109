...
import com.document.allreader.allofficefilereader.fc.poifs.filesystem.OfficeXmlFileException;
...
public class ErrorUtil
{
    ...
    private void processThrowable(final Throwable ex, final boolean isReaderFile)
    {
        ...
        final AppCompatActivity activity = control.getMainFrame().getActivity();
            ...
            control.getActivity().getWindow().getDecorView().post(new Runnable()
            {
                ...
                {                 
                    ...
                    {                 
                        ...
                        else if (error.contains("Cannot process encrypted allofficefilereader file"))
                        {
...
//                                message.show();
                    ...
                    {
                        Dialog dialog = new Dialog(control.getActivity());
                        View view = LayoutInflater.from(control.getActivity()).inflate(R.layout.dialog_err, null, false);
                        ...
                        int w = (int) (control.getActivity().getResources().getDisplayMetrics().widthPixels * 0.8);
                        int h = ViewGroup.LayoutParams.WRAP_CONTENT;
                        dialog.getWindow().setLayout(w, h);

                        TextView btnOK = view.findViewById(R.id.tvOK);
                        btnOK.setOnClickListener(v->{control.getActivity().onBackPressed();});
                        dialog.show();
                        eee.printStackTrace();
                    }
                }
