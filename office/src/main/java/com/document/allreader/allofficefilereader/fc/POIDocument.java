...
import com.document.allreader.allofficefilereader.fc.hpsf.DocumentSummaryInformation;
import com.document.allreader.allofficefilereader.fc.hpsf.MutablePropertySet;
import com.document.allreader.allofficefilereader.fc.hpsf.PropertySet;
import com.document.allreader.allofficefilereader.fc.hpsf.PropertySetFactory;
import com.document.allreader.allofficefilereader.fc.hpsf.SummaryInformation;
...
public abstract class POIDocument
{
    ...
    protected PropertySet getPropertySet(String setName)
    {
        ...
        catch(com.document.allreader.allofficefilereader.fc.hpsf.HPSFException he)
        {
            // Oh well, doesn't exist
            logger.log(POILogger.WARN, "Error creating property set with name " + setName + "\n"
                + he);
        ...
        throws IOException
    {
        ...
        catch(com.document.allreader.allofficefilereader.fc.hpsf.WritingNotSupportedException wnse)
        {
